...
from modules.layers.upsampling import CubicUpsampling1d,CubicUpsampling2d,upsample_layer
from modules.layers.stdmap import StdMap1d
from modules.layers.fouriermap import FFTMap1d
from modules.progressive import ProgressiveGenerator,ProgressiveGeneratorBlock,\
							ProgressiveDiscriminator,ProgressiveDiscriminatorBlock
from modules.wgan import WGAN_I_Generator,WGAN_I_Discriminator
from modules.layers.xray import xrayscanner
from modules.layers.add_random_layer import add_random_layer

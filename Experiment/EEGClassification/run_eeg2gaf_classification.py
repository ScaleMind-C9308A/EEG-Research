...
from Encoder.image_encoder import load_image_encoder_gaf
...
def run():
    ...
    # Step 2: Set model
    model = load_image_encoder_gaf(args.img_encoder, args.num_classes, args.img_feature_extract, pretrained=True)
